  ...
  <div class="container">
    <div class="card-list-product">
      <div class="card-header">
        <h6 style="margin-bottom: 1rem;">Cari Produk Recall</h6>
        ...
        <div class="product-scrolling">
            <table class="product-list-table">
                <tr v-for="item in data" :key="item.no_reg" @click="detail(item)">
                    <td width="63px">
                        <span class="badge-ob">{{ item.type }}</span>
                    </td>
                    <td width="240px">
                        <span class="product-number">{{ item.recall.no }}</span>
                        <small class="product-date">{{ item.recall.date }}</small>
                    </td>
                    <td width="300px">
                    ...
                    <td width="120px">
                      <span class="product-info-small">{{ item.recall.bets }}</span>
                    </td>
                    <td width="160px">
                    ...
                    <td>
                      <span class="product-info-medium">{{ item.recall.reason }}</span>
                    </td>
                </tr>
            </table>
...
<script>
  import produk from '@/static/data/produk-recall.json'
